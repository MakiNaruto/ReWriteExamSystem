...
public class MultipleChoice extends JPanel{
	...
	public MultipleChoice() {
		...
		textField_1.setBounds(159, 291, 401, 30);
		add(textField_1);
		textField_1.setColumns(10);
		
		textField_2 = new JTextField();
		textField_2.setColumns(10);
		textField_2.setBounds(159, 341, 401, 30);
		add(textField_2);
		
		textField_3 = new JTextField();
		textField_3.setColumns(10);
		textField_3.setBounds(159, 386, 401, 30);
		add(textField_3);
		
		textField_4 = new JTextField();
		textField_4.setColumns(10);
		textField_4.setBounds(159, 433, 401, 30);
		add(textField_4);
		...
		button1.setBounds(309, 473, 109, 38);
		add(button1);
